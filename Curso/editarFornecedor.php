...
<body>
	<div class="container" id="tamanhoContainer" style="margin-top: 100px">
		...
		<form action="atualizarFornecedor.php" method="post" style="margin-top: 50px">
			<?php
			...
			while($array = mysqli_fetch_array($busca)){
				...
				<div class="form-group">
					<label>Nome</label>
					<input type="text" class="form-control" name="nome" value="<?php echo $nome ?>" required="required" autocomplete=off>
